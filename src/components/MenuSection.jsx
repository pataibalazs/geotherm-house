...
export default function MenuSection({ imageUrl, text, variant = "elegant" }) {
  ...
  return (
    ...
    >
      ...
      {/* Sötét overlay a jó olvashatósághoz; hover-re finoman csökken */}
      <div className="absolute inset-0 bg-black/40 transition-colors duration-300 group-hover:bg-black/25" />

      {/* Tartalom */}
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="relative block text-center">
          <span className="block text-white text-3xl sm:text-4xl font-semibold tracking-wide drop-shadow-[0_1px_2px_rgba(0,0,0,0.6)]">
            {text}
          </span>
