...
const ContactPage = () => {
  ...
  return (
    <div className="bg-stone-50 flex flex-col items-center">
      ...
      <main className="flex flex-col items-center p-6 bg-stone-50 rounded-lg mt-10 mb-10 max-w-80 xs:max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl w-full">
                  ...
                  >
                    ...
                    <div className="mt-10">
                      <button
                        ...
                        className={`block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-all duration-200 ${
                          state.submitting
